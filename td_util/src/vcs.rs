...
//! Version-control backend selector for Target Determinator callers.
...
/// Version-control system backing a checkout.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default, ValueEnum)]
pub enum Vcs {
    /// Sapling or Mercurial, driven through the `sl` CLI.
    #[default]
